"""
Django settings for recipe_service_core project.
...
SECRET_KEY = 'django-insecure-hx5c^4zc!ulqh2k9^=(8%#8iv2aw9*i$k9v&$ebk2^facln=w('
...
ROOT_URLCONF = 'recipe_service_core.urls'
...
WSGI_APPLICATION = 'recipe_service_core.wsgi.application'
